...
public class C10_Split {
    ...
    public static void main(String[] args) {
        ...
        /*
        split methodu String'i Arraya cevirir ve Array dondugu icin
        bir arraya atamaliyiz(String[] kelimeler)
         */
        System.out.println(Arrays.toString(kelimeler)); // [Java, ne, kadar, guzel] // ", " Java otomatik olarak
                                                        // ayirmak istedigimiz yere koyar
