...
public class M02_Child implements I01_InterfaceBodyOlanMethod{
    ...
    public static void main(String[] args) {
        I01_InterfaceBodyOlanMethod.direksiyon();// direksiyon methodu static oldugu icin intrface ismi ile cagirabildik
        M02_Child obj= new M02_Child();
        obj.teker(); // teker methodu default oldugu icin ulasabilmemiz icin obje olusturmaliyiz
    }
}
