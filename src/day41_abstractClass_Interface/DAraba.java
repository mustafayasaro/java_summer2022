...
public abstract class DAraba {
    public static void main(String[] args) {
        /*
          Abstract class'da main method olmak zorunda degil, olabilir olmayadabilir
          Eger abstract class sadece child class'larin tasimak zorunda oldugu
          ozellikleri belirlemek icin olusturulduysa main method'a ihtiyac olmaz
    ...
    public void klima() {
        ...
        abstract bir method'u abstract keyword'u ile belirtmek zorunludur
