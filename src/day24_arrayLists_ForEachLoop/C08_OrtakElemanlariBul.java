...
public class C08_OrtakElemanlariBul {
    ...
    public static void main(String[] args) {
        ...
        List<String> ortakIsimle = new ArrayList<>();
        ...
        for (String each1 : arr1
            ...
            for (String each2 : arr2
                ...
                if (each1.equalsIgnoreCase(each2)) {
                    ortakIsimle.add(each1);
                }
            }
        }

        if (ortakIsimle.isEmpty()) {
            System.out.println("Hic ortak eleman yok");
        } else {

            System.out.println("Her iki array'deki ortak isimler : " + ortakIsimle);
            //Her iki array'deki ortak isimler : [Ali, Ayse]
        }
    }
}
