...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ortalamaPuanlarverilenSayıdanBüyükMu(coursesList, 93));
        System.out.println("kelimeKursAdlariIcindeVarMi = " + kelimeKursAdlariIcindeVarMi(coursesList, "Day"));
        // kelimeKursAdlariIcindeVarMi = true
        ortalamasiEnYuksekKurs(coursesList);
        // Turkish Night
        System.out.println("ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla = " + ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList,3));
    }

    //1)Tüm ortalama puanların verilen sayıdan büyük olup olmadığını kontrol etmek için bir method oluşturun.

    public static boolean ortalamaPuanlarverilenSayıdanBüyükMu(List<Courses> list, double x){
    ...
    public static List<Courses> ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(List<Courses> list, long x){
